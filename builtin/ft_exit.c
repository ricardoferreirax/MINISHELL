...
// basicament piped é no caso de existir um próximo node na pipeline.
// caso seja o último mas vier de um pipe anterior, o exit deve ser 
// deve ser executado no child pelo eggexecutor.
...
static int exit_handle_args(t_cmd *cmd, t_mini *mini, int piped, int *exit_code)
{
    int arg_check;
